...
// deltaEndpointFor maps a bronze kind to its Graph delta path (relative to base)
// for the first page. "" means the kind has no wired pull yet.
...
func (p *microsoftPuller) get(token, target string) (graphDeltaPage, error) {

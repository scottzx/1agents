...
// afterSyncSilver runs the transform and folds a compact summary into a sync
...
// HandleRunSilver: POST /api/data/silver/run → run bronze→silver now and return
// the per-domain counts. The manual "重新清洗" control behind the 数据归一 viewer.

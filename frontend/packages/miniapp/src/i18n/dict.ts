...
export const zhCN: Record<string, string> = {
  ...
  'more.ccConnect': '渠道',
  'more.ccConnect.desc': '消息平台渠道接入(cc-connect)',
  'ccConnect.loading': '正在打开…',
...
export const enUS: Record<string, string> = {
  ...
  'more.ccConnect': 'Channels',
  'more.ccConnect.desc': 'Messaging-platform channels (cc-connect)',
  'ccConnect.loading': 'Opening…',

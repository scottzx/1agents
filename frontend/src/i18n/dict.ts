...
export const zhCN: Record<string, string> = {
    ...
    'chat.sessionMode.id.default': '询问模式',
    'chat.sessionMode.id.acceptEdits': '自动编辑',
    'chat.sessionMode.id.plan': '规划模式',
    'chat.sessionMode.id.auto': '智能放行',
    'chat.sessionMode.id.dontAsk': '不再询问',
    'chat.sessionMode.id.bypassPermissions': '跳过权限',
    'chat.sessionMode.id.read-only': '只读模式',
    'chat.sessionMode.id.agent': '代理模式',
    'chat.sessionMode.id.agent-full-access': '完全访问',

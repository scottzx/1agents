...
> **已被取代（2026-07-30）：**本文保留为历史设计记录。其“Go/SQLite 是 Turn
> 身份和队列唯一真源”的核心结论已由
> [Turn 权威 Journal 迁移与实现记录（方案 A）](./journal-authority-migration.md)
> 取代。现行实现以 1ACP 本地 Journal 为权威事实，`agent_turns` 为异步可重建投影。

| 字段     | 内容                                                                                                  |
| -------- | ----------------------------------------------------------------------------------------------------- |
| 状态     | **Superseded / 仅保留为历史记录**                                                                     |
| 日期     | 2026-07-29                                                                                            |
